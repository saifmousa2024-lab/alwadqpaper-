    ...
    <div class="container">
      <div class="navbar">
        ...
        <nav id="navLinks" class="links" aria-label="Navigation">
          ...
          <a class="link" data-nav href="products.html" data-i18n="nav_products"> </a>
          <a class="link" data-nav href="contact.html" data-i18n="nav_contact"> </a>
    ...
    <section class="section" style="padding-top:0;">
      <div class="container grid two" style="align-items:start;">
        ...
        <div class="card">
          ...
          <div class="notice" data-i18n="innovation_note">This is a static MVP: implemented with canvas patterns. A full version can use WebGL/AR.</div>
          <div class="hr"></div>
          <a class="btn primary" href="visualizer.html" data-i18n="viz_badge">Visualizer</a>
        </div>
      </div>
    </section>
  </main>
      ...
      <div class="row">
        <div>
          <div class="brand" style="margin-bottom:8px;">
            <img src="assets/img/logo.svg" alt="Al-Wadaq logo" />
            <span class="brand-text"><strong>Al-Wadaq</strong><span data-i18n="city">Babel, Iraq</span></span>
          </div>
